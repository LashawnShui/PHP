...
<!--
//$.xycmsInc([ 'Js/xycms.admin.min.js','Css/style.css']);
...
<div class="mainbox">
  ...
  <div id="system"  class="list">
    ...
    <ul>
      <li><span>程序的绝对路径:</span><?php echo $_SERVER['DOCUMENT_ROOT'];?></li>
  ...
  <div id="coprights" class="list">
    ...
    <ul>
      <li><span>程序版本:</span>R v1.2 [免费无限制]</li>
      <li><span>授权类型:</span><b id="xycms_license">无需授权，直接使用</b></li>
      <li><span>技术支持:</span><b id="xycms_sn">QQ905300721</b></li>
      <li><span>程序说明:</span> <b id="xycms_update">此程序版权归开发者拥有，任何单位或者个人不得进行买卖行为！</b></li>
      <li><span>官方网站:</span>https://github.com/LashawnShui/PHP</li>
      <li></li>
      <li></li>
    </ul>
  </div>
